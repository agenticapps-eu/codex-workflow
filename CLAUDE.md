...
This project is indexed by GitNexus as **codex-workflow** (674 symbols, 712 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
