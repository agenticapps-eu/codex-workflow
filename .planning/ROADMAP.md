...
- [ ] 09-01-PLAN.md — Empirical anchor replay against real + gitnexus-led AGENTS.md, with counter-replays; evidence recorded (ANCHOR-01..04) — wave 1
- [ ] 09-02-PLAN.md — Fence-scoped document extractor + shape guards; retire the inlined anchor copy at run-tests.sh:119 (TEST-01, TEST-04) — wave 1
...
| 9. Region-Aware §11 Placement   | v0.7.0    | 0/5             | Planned     | -          |
